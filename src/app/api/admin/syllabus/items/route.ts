...
// GET - Fetch syllabus items for a specific class
export async function GET(request: NextRequest) {
  try {
    ...
    return NextResponse.json(
      { success: false, error: 'Failed to fetch syllabus items' },
      { status: 500 }
    );
  }
}

// POST - Create a new syllabus item
export async function POST(request: NextRequest) {
  try {
    ...
    return NextResponse.json(
      { success: false, error: 'Failed to create syllabus item' },
      { status: 500 }
    );
  }
}

// PUT - Update a syllabus item
export async function PUT(request: NextRequest) {
  try {
    ...
    return NextResponse.json(
      { success: false, error: 'Failed to update syllabus item' },
      { status: 500 }
    );
  }
}

// DELETE - Delete a syllabus item
export async function DELETE(request: NextRequest) {
  try {
    ...
    return NextResponse.json(
      { success: false, error: 'Failed to delete syllabus item' },
      { status: 500 }
    );
  }
}