...
export default async function SyllabusPage() {
  ...
  const apiUrl = `${protocol}://${host}/api/syllabus`;
  ...
  try {
    ...
    console.error('Failed fetching syllabus data:', err);
    classes = [];
  }
  ...
  return (
    <div className="bg-gray-50">
      ...
      {/* Body Section */}
      <main className="b-green max-w-7xl mx-auto px-6 py-10">
        <div className="bg-white rounded-xl shadow-sm border border-gray-200">
          <div className="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
            <h2 className="text-xl font-semibold text-gray-800">Syllabus Classes</h2>
